...
module Wagg
  module Utils
    module Constants
      ...
      COMMENT_VOTES_LIFETIME = 30*24*60*60 + 24*60*60 # 30 days
      ...
      NEWS_CONTRIBUTION_LIFETIME = 30*24*60*60 + 24*60*60 # 30 days
      NEWS_VOTES_LIFETIME = 30*24*60*60 + 24*60*60 # 30 days
